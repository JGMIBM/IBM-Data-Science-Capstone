...
def get_pie_chart(selected_site):
    ...
    if selected_site == 'ALL':
        ...
        success_df = spacex_df[spacex_df["Launch Site"] == selected_site]["class"].value_counts().to_frame()
        success_df["name"] = ["Success","Failure"]
        fig = px.pie(success_df, values='count', names='name', title='Total Success Launches for ' + selected_site)
    return fig
# TASK 4:
